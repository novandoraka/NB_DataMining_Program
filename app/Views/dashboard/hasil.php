        ...
        <div class="content-wrapper">
            ...
            <div class="card card-default">
                <!-- <div class="card-header">
                    <h1 class="card-title">Uji Algoritma Naive Bayes</h1>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <label>Perhitungan Label</label>
                            <div class="info-box bg-success">
                                <span class="info-box-icon"><i class="fa-solid fa-table"></i></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Jumlah Data Training :</span>
                                    <?php
                            ...
                            <div class="info-box bg-success">
                                <span class="info-box-icon"><i class="fa-solid fa-tags"></i></span>
                                <div class="info-box-content">
                            ...
                            <div class="info-box bg-success">
                                <span class="info-box-icon"><i class="fa-solid fa-table"></i></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Probabilitas Kelas :</span>
                                    <h8>Layak =
                                        <?php
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label>Proses Perhitungan</label>
                                <div class="info-box bg-info">
                                    <!-- <span class="info-box-icon"><i class="far fa-bookmark"></i></span> -->
                                    <div class="info-box-content">
                                        <b><span class="info-box-text">Probabilitas Atribut Pengelolahan Usaha : <?php echo $_POST['kls']; ?></span></b>
                                        <?php
                                        // foreach ($atribut as $key => $value) {
                                        // }
                                        // var_dump($atribut);
                                        var_dump($atribut['pengelolahan']);
                                        // dd($value);
                                        ?>
                                    </div>
                                    <!-- /.info-box-content -->
                                ...
                                <div class="info-box bg-info">
                                    <!-- <span class="info-box-icon"><i class="far fa-bookmark"></i></span> -->
                                    <div class="info-box-content">
                                        <b><span class="info-box-text">Probabilitas Atribut Jenis Usaha : <?php echo $_POST['jusaha']; ?></span></b>
                                        <?php
                                        // foreach ($atribut as $key => $value) {
                                        // }
                                        // var_dump($atribut);
                                        var_dump($atribut['jenis']);
                                        ?>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                                ...
                                <div class="info-box bg-info">
                                    <!-- <span class="info-box-icon"><i class="far fa-bookmark"></i></span> -->
                                    <div class="info-box-content">
                                        <b><span class="info-box-text">Probabilitas Atribut Tenaga Kerja : <?php echo $_POST['JTK']; ?></span></b>
                                        <?php
                                        // foreach ($atribut as $key => $value) {
                                        // }
                                        // var_dump($atribut);
                                        var_dump($atribut['tenagakerja']);
                                        ?>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                                ...
                                <div class="info-box bg-info">
                                    <!-- <span class="info-box-icon"><i class="far fa-bookmark"></i></span> -->
                                    <div class="info-box-content">
                                        <b><span class="info-box-text">Probabilitas Atribut Luas Bangunan : <?php echo $_POST['LB']; ?></span></b>
                                        <?php
                                        // foreach ($atribut as $key => $value) {
                                        // }
                                        // var_dump($atribut);
                                        var_dump($atribut['bangunan']);
                                        ?>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                                ...
                                <div class="info-box bg-info">
                                    <!-- <span class="info-box-icon"><i class="far fa-bookmark"></i></span> -->
                                    <div class="info-box-content">
                                        <b><span class="info-box-text">Probabilitas Atribut Omset : <?php echo $_POST['omset']; ?></span></b>
                                        <?php
                                        // foreach ($atribut as $key => $value) {
                                        // }
                                        // var_dump($atribut);
                                        var_dump($atribut['pendapatan']);
                                        ?>
                                    </div>
                                    <!-- /.info-box-content -->
                                </div>
                                ...
                                <div class="info-box bg-info">
                                    <!-- <span class="info-box-icon"><i class="far fa-bookmark"></i></span> -->
                                    <div class="info-box-content">
                                        <b><span class="info-box-text">Probabilitas Atribut Tahun Berdiri : <?php echo $_POST['TH']; ?></span></b>
                                        <?php
                                        // foreach ($atribut as $key => $value) {
                                        // }
                                        // var_dump($atribut);
                                        var_dump($atribut['berdiri']);
                                        ?>
                                ...
                                <form action="/Home/simpanPrediksi" class="col-sm-3" method="post">
                                    <div class="form-group">
                                        <input value="<?php echo $_POST['kls']; ?>" name="kls" type="input" class="form-control" id="exampleInputEmail1" placeholder="Pengelolahan Usaha" hidden>
                                    </div>
                                    <div class="form-group">
                                        <input value="<?php echo $_POST['jusaha']; ?>" name="jusaha" type="input" class="form-control" id="exampleInputEmail1" placeholder="Jenis Usaha" hidden>
                                    </div>
                                    <div class="form-group">
                                        <input value="<?php echo $_POST['JTK']; ?>" name="JTK" type="input" class="form-control" id="exampleInputEmail1" placeholder="Jumlah Tenaga Kerja" hidden>
                                    </div>
                                    <div class="form-group">
                                        <input value="<?php echo $_POST['LB']; ?>" name="LB" type="input" class="form-control" id="exampleInputEmail1" placeholder="Luas Bangunan" hidden>
                                    </div>
                                    <div class="form-group">
                                        <input value="<?php echo $_POST['omset']; ?>" name="omset" type="input" class="form-control" id="exampleInputEmail1" placeholder="Omset" hidden>
                                    </div>
                                    <div class="form-group">
                                        <input value="<?php echo $_POST['TH']; ?>" name="TH" type="input" class="form-control" id="" placeholder="Tahun Berdiri" hidden>
                                    </div>
                                    <div class="form-group">
                                        <input value="<?=
                                                        $hasil;
                                                        ?>" name="kep" type="input" class="form-control" id="" placeholder="Keputusan" hidden>
                                    </div>
                                    <button type="submit" class="btn btn-primary col-sm-12" data-toggle="modal" data-target="">
                                        <i class=""></i> Simpan
                                    </button>
